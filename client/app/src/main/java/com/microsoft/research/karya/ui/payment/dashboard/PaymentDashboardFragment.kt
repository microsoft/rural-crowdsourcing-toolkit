...
class PaymentDashboardFragment : Fragment(R.layout.fragment_payment_dashboard) {
    ...
    private fun setupListeners() {
        viewModel.navigationFlow.onEach { paymentDashboardNavigation ->
            navigate(paymentDashboardNavigation)
        ...
        binding.transactionsButton.setOnClickListener {
            navigate(PaymentDashboardNavigation.TRANSACTIONS)
        }

        binding.updateAccountButton.setOnClickListener {
            navigate(PaymentDashboardNavigation.REGISTRATION)
        }
    }
    ...
    private fun navigate(paymentDashboardNavigation: PaymentDashboardNavigation) {
        val resId = when (paymentDashboardNavigation) {
