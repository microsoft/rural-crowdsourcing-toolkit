...
class SkillSpecification : BaseActivity(useAssistant = true) {
    ...
    override suspend fun getStringsForActivity() {
        ...
        skillQuestionDescription = skillQuestionDescription
            .replace("<tick>", "(✔)")
            .replace("<cross>", "(✖)")
    ...
    /**
     * On assistant click, if new skill, play the audio for skill question description
     * play the read skill question.
     */
    ...
    private fun updateSubmitButtonState() {
        if (canRead != null && canSpeak != null && canType != null &&
