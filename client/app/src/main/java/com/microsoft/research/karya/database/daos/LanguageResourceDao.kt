...
import com.microsoft.research.karya.database.models.LanguageResourceRecord

@Dao
interface LanguageResourceDao : BasicDao<LanguageResourceRecord> {

    @Query("SELECT * FROM language_resource")
    suspend fun getAll(): List<LanguageResourceRecord>
