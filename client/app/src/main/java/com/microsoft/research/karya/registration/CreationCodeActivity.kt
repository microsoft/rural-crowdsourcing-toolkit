...
class CreationCodeActivity : BaseActivity(useAssistant = true) {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    phantomCCTv.addOnLayoutChangeListener {
        _: View,
        _: Int,
        _: Int,
        _: Int,
  ...
  /**
   * Handle full creation code entry by the user. Currently will automatically check if the creation
   * code is valid by sending a request to the server
   */
