 ...
 */
package com.microsoft.research.karya.consentForm
...
import com.microsoft.research.karya.registration.CreationCodeActivity
...
class ConsentFormActivity : BaseActivity(useAssistant = true) {
  ...
  override fun onAssistantClick() {
    ...
    playAssistantAudio(
        R.string.audio_consent_form_summary,
