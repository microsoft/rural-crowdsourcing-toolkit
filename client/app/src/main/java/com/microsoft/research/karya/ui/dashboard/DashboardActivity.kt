...
//
//    val syncText = "$getNewTasksString - $submitCompletedTasksString - $getVerifiedTasksString -
// $updateEarningString"
...
//  //              .map {
//  //                // TODO: Remove it
//  //                // TODO: Fetch Scenario name from Task table and then fetch the corresponding
//  // xml
//  //                // resource
//  //                var scenarioName =
//  //                    karyaDb
...
//  //            tasksAvailableString, tasksCompletedString, tasksSubmittedString,
//  // tasksVerifiedString)
//  //
//  //        /** Set the task list */
...
//    nextIntent.putExtra("incomplete", task.taskStatus.assignedMicrotasks)
//    nextIntent.putExtra("completed", task.taskStatus.completedMicrotasks)
//
...
//    //    workManager.enqueueUniqueWork(PerformSyncBackground.WORK_NAME, ExistingWorkPolicy.KEEP,
//    // task)
//    //
...
//  //            // output_file_id is the id of the file in the blob storage(cloud) and will be
//  // non-empty
...
//  //      //        val tarBallName =
<<<<<<< Updated upstream
//  //      // getBlobName(BaseActivity.KaryaFileContainer.MICROTASK_ASSIGNMENT_OUTPUT,
// assignment.id)
=======
...
//  //
//  //      val requestFile = RequestBody.create("application/tgz".toMediaTypeOrNull(),
//  // File(tarBallPath))
//  //
...
//  //              md5sum)
//  //
//  //      val dataPart = MultipartBody.Part.createFormData("data",
// Gson().toJson(uploadFileRequest))
//  //
//  //      // Make the call
//  //      val call =
...
//  //      // in the server. Create a file record in karya_fie database and update the output file
// id
//  // in
...
//  ////            val languageResources: ArrayList<LanguageResourceRecord> = gson.fromJson(rows,
//  // listType)
...
//  ////            val taskAssignments: ArrayList<TaskAssignmentRecord> = gson.fromJson(rows,
//  // listType)
//  ////            karyaDb.taskAssignmentDao().upsert(taskAssignments)
//  ////          }
//  ////          "microtask_group" -> {
//  ////            val listType = object : AType<MicrotaskGroupRecord>() {}.type
//  ////            val microtaskGroups: ArrayList<MicrotaskGroupRecord> = gson.fromJson(rows,
//  // listType)
...
//  //
//  //    /**
//  //     * Remove karya files that are already uploaded to the server. Remove input files of
//  // submitted
//  //     * microtasks
//  //     */
...
//  //      return getBlobPath(BaseActivity.KaryaFileContainer.MICROTASK_ASSIGNMENT_OUTPUT,
//  // assignment.id)
//  //    }
//  //
...
//  //      return getBlobPath(BaseActivity.KaryaFileContainer.MICROTASK_INPUT,
