...
interface KaryaAPIService {
  ...
  @GET("/language_resource") suspend fun getLanguageResources(): Response<List<LanguageResourceRecord>>

  @GET("/language_resource_value") suspend fun getLanguageResourceValues(): Response<List<LanguageResourceValueRecord>>
  ...
  @PUT("/worker/phone-auth?resend=true") suspend fun resendOTP(@Body worker: JsonObject): Response<WorkerRecord>
