...
class PaymentRepository @Inject constructor(
    ...
    suspend fun updatePaymentRecord(
        ...
        val paymentAccountRecord = PaymentAccountRecord(
            workerId = workerId,
    ...
    suspend fun getAccountRecordId(workerId: String) = withContext(Dispatchers.IO) {
    ...
    suspend fun getPaymentRecordStatus(workerId: String) = withContext(Dispatchers.IO) {
