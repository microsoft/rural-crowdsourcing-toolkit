 ...
 */
@AndroidEntryPoint
abstract class NgMicrotaskRenderer(
   ...
   */
  protected abstract fun setupActivity() // Should be in the Renderer Fragment
  ...
  protected abstract fun resetOnRestart() // Set on Base Viewmodel class
