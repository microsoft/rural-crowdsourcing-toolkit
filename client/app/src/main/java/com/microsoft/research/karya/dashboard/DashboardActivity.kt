...
import com.microsoft.research.karya.database.modelsExtra.UploadFileRequest
import com.microsoft.research.karya.networking.RetrofitFactory
import com.microsoft.research.karya.scenarios.speechData.SpeechDataMain
import com.microsoft.research.karya.scenarios.speechVerification.SpeechVerificationMain
import com.microsoft.research.karya.scenarios.storySpeech.StorySpeechMain
import com.microsoft.research.karya.selectAppLanguage.SelectAppLanguage
import com.microsoft.research.karya.skillSpecification.SkilledLanguageList
    ...
    bottomNavigationView.setOnNavigationItemSelectedListener { item ->
      when (item.itemId) {
        R.id.navigation_language -> {
          ...
          nextIntent.putExtra(AppConstants.SELECT_APP_LANGUAGE_CALLER, AppConstants.DASHBOARD)
          startActivity(nextIntent)
        }
        R.id.navigation_skills -> {
          val nextIntent = Intent(applicationContext, SkilledLanguageList::class.java)
          nextIntent.putExtra(AppConstants.SKILLED_LANGUAGE_LIST_CALLER, AppConstants.DASHBOARD)
          startActivity(nextIntent)
        }
      }
      true
