...
class SkilledLanguageList
    : BaseActivity(useAssistant = true), SkilledLanguageClickListener {
    ...
    private fun updateSkilledLanguages() {
        ioScope.launch {
            ...
            uiScope.launch {
                skilledLanguageListAdapter.setList(skilledLanguages)
            }
        }
    }

    /**
     * When a language is selected, move to the skill specification activity for the selected
     * language
     */
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SkilledLanguageViewHolder {
        return SkilledLanguageViewHolder(
            LayoutInflater.from(context).inflate(
                R.layout.item_skilled_language, parent, false
            )
        )
    }
