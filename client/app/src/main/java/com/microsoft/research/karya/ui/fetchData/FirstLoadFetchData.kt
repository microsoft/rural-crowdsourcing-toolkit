...
class FirstLoadFetchData :
  ...
  /**
   * This activity is run before the user has fetched any language. Therefore, it is not possible to
   * display any message or error.
   */
  ...
  override fun startNextActivity() {
    ...
    nextIntent.putExtra(AppConstants.SELECT_APP_LANGUAGE_CALLER, AppConstants.FETCH_DATA_ON_INIT)
