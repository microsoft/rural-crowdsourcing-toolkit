...
/**
 * Specification of the text-translation scenario.
 */
...
export const TextTranslationScenario: IScenario = {
  ...
  /**
 * Handle completion of a Text Translation data microtask at the server
 ...
 * Output generator
 */
async function outputGenerator(task: TextTranslationTask) {
